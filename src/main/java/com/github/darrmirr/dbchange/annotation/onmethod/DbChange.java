package com.github.darrmirr.dbchange.annotation.onmethod;
...
/**
 * Meta information about RDBMS changes before/after each test execution in class.
 *
 * Sql query sources:
 *   - changeSet
 *   - sqlQueryGetter
...
public @interface DbChange {
     ...
     * Use {@link DbChange#sqlQueryGetter()} for classes with constructor with parameters.
     *
     * Notice:
     ...
     *
     * @return instance of {@link DbChange.ExecutionPhase}
     */
    ExecutionPhase executionPhase() default ExecutionPhase.BEFORE_TEST;
